...
class OPCClientController extends BaseController
{
    ...
    {
        try{
        return json_decode(Http::get(self::$OpcApiIp . ":" . self::$OpcApiPort . "/client/inventory"));
        }catch (\Exception $e) {
            return json_encode(['first' => null, 'second' => $e->getMessage()]);
        }
    }
    ...
    {
        try{
        return json_decode(Http::get(self::$OpcApiIp . ":" . self::$OpcApiPort . "/client/resource/".$name));
        }catch (\Exception $e) {
            return json_encode(['first' => null, 'second' => $e->getMessage()]);
        }
    }
    ...
    {
        try{
        return json_decode(Http::get(self::$OpcApiIp . ":" . self::$OpcApiPort . "/sanity"));
        }catch (\Exception $e) {
